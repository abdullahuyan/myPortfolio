export const data = {
  tr: {
    ...
    skills:{
      title:"Yetenekler",
      items:[
        {name: "Java Script", desc:"Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."},
        {name: "React.Js", desc:"Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."},
        {name: "Node.Js", desc:"Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."},
      ]},
    profile: {
      title: "Profil",
      basic: {
    ...
    contacts: {
      ...
      socials:{personalBlog:"", github:"https://github.com/abdullahuyan", linkedin:"https://www.linkedin.com/in/abdullahuyan/"}
    }
  },
    en: {
      header:{ 
      ...
      profile:{
        ...
        basic:{
          ...
          items:[
            ...
            {
                label: "Education",
                value: "İstanbul University, Computer Engineering, 2013"
            },
            {
          ...
          desc:"Lorem ipsum, dolor sit amet consectetur adipisicing elit.Veniam aut, odit laborum aliquam voluptatum nisi mollitia.Mnima accusamus ratione soluta aperiam sit voluptate? Dicta quod deserunt quam temporibus cumque magnam!",}},
    projects:{
      title: "Projects",
      items: [
          {
